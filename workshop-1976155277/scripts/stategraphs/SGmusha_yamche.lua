...
-------------------------------------------------------------------
    ...
    State{
        ...
        timeline = 
        {
          ...
          events=
        {
            EventHandler("animover", function(inst) inst.sg:GoToState("walk") inst.level = 0 inst.growing = false end),
        },
    },
...
return StateGraph("musha_yamche", states, events, "idle", actionhandlers)
