...
local states =
{
 ...
 State{
        ...
        onenter = function(inst, noanim)
            ...
            inst.SoundEmitter:PlaySound("dontstarve/woodie/talk")
			if inst.talksoundoverride then
				...
				--inst.SoundEmitter:PlaySound("dontstarve/characters/webber/talk_LP", "talk")
            end 
			--end
...
return StateGraph("assasin_webber", states, events, "idle", actionhandlers)