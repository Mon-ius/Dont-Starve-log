...
local function Hatch1(inst)
    ...
    local rp1= SpawnPrefab("musha_tall2")
...
local function Hatch2(inst)
    ...
    local rp2= SpawnPrefab("musha_tallrr1")
...
local function Hatch3(inst)
    ...
    local rp3= SpawnPrefab("musha_tallrr2")
...
local function Hatch4(inst)
    ...
    local rp4= SpawnPrefab("musha_tallrr3")
...
local function Hatch5(inst)
    ...
    local rp5= SpawnPrefab("musha_tallrr4")
...
local function Hatch6(inst)
    ...
    local rp6= SpawnPrefab("musha_tallrr5")
...
local function OnHatchState(inst, state)
    ...
    if state == "crack" then
        local cracked = SpawnPrefab("musha_egg_cracked3")
...
local inst = CreateEntity()
    ...
    inst.AnimState:SetBuild("musha_eggs3")
	...
	inst.MiniMapEntity:SetIcon( "musha_eggs3.tex" )
	...
	if cookable then
		inst.components.inventoryitem.atlasname = "images/inventoryimages/musha_eggs3.xml"
        inst:AddComponent("cookable")
        inst.components.cookable.product = "musha_egg_cookeds3"
    end
...
local function crackedfn()
   local inst = defaultfn("idle_happy")
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/musha_egg_crackeds3.xml"
...
local function cookedfn()
	...
	inst.components.inventoryitem:ChangeImageName("musha_egg_crackeds3")
	inst.components.inventoryitem.atlasname = "images/inventoryimages/musha_egg_crackeds3.xml"
...
return Prefab( "common/inventory/musha_eggs3", normalfn, assets, prefabs),
		Prefab( "common/inventory/musha_egg_crackeds3", crackedfn, assets),
		Prefab("musha_egg_cookeds3", cookedfn, assets)
