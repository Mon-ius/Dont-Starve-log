...
local assets=
{
	...
	Asset("ATLAS", "images/inventoryimages/mushasword_fire.xml"),
	Asset("IMAGE", "images/inventoryimages/mushasword_fire.tex"),
...
local function fn()
  ...
  local player = GetPlayer()
   ...
   inst:AddComponent("weapon")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/mushasword_fire.xml"
...
return Prefab( "common/inventory/mushasword_fire", fn, assets) 
