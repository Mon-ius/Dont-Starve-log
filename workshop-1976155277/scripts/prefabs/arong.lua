  ...
  --  local herd = inst.components.herdmember and inst.components.herdmember:GetHerd()
    local basebuild = (inst:HasTag("baby") and "arong_baby_build")
		  ...
		  -- or (inst.components.domesticatable:IsDomesticated() and "beefalo_domesticated")
			or (inst.components.domesticatable:IsDomesticated() and "arong_build")
            or "arong_build"
...
--inst.MiniMapEntity:SetIcon( "arong.txt" )
inst.follow = false
end
end
...
--[[
    ...
    inst.components.lootdropper:SetChanceLootTable('arong')
