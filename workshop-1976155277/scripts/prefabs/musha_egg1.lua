...
local inst = CreateEntity()
	...
	if cookable then
        ...
        inst.components.cookable.product = "musha_egg_cooked1"
    end
...
local function cookedfn()
	...
	inst.components.inventoryitem:ChangeImageName("musha_egg_cracked1")
	inst.components.inventoryitem.atlasname = "images/inventoryimages/musha_egg_cracked1.xml"
...
return Prefab( "common/inventory/musha_egg1", normalfn, assets, prefabs),
		Prefab( "common/inventory/musha_egg_cracked1", crackedfn, assets),
		Prefab("musha_egg_cooked1", cookedfn, assets)
