...
inst.components.talker:Say(STRINGS.MUSHA_HAT_QUEEN.." \n"..STRINGS.MUSHA_ITEM_GROWPOINTS.."\n".. (inst.level).."/1600")
...
local function OnBlocked(owner) 
	...
	if inst.level <750 then --750 LV16
	inst.components.equippable.dapperness = TUNING.DAPPERNESS_TINY
	elseif inst.level >=750 then	--1400 LV21
	inst.healing1 = true
...
local function fn(Sim)
    ...
    inst.AnimState:SetBuild("hat_mcrown")
