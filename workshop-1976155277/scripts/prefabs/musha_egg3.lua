...
local function Hatch1(inst)
    ...
    local rp1= SpawnPrefab("musha_tall5")
...
local function Hatch2(inst)
    ...
    local rp2= SpawnPrefab("musha_tallrrrrr1")
...
local function Hatch3(inst)
    ...
    local rp3= SpawnPrefab("musha_tallrrrrr2")
...
local function Hatch4(inst)
    ...
    local rp4= SpawnPrefab("musha_tallrrrrr3")
...
local function Hatch5(inst)
    ...
    local rp5= SpawnPrefab("musha_tallrrrrr4")
...
local function Hatch6(inst)
    ...
    local rp6= SpawnPrefab("musha_tallrrrrr5")
...
local function Hatch7(inst)
    ...
    local rp7= SpawnPrefab("musha_tallrrrrr6")
...
local function OnHatchState(inst, state)
    ...
    if state == "crack" then
        local cracked = SpawnPrefab("musha_egg_crackeds3")
...
local inst = CreateEntity()
    ...
    inst.AnimState:SetBuild("musha_egg3")
	...
	inst.MiniMapEntity:SetIcon( "musha_egg3.tex" )
	...
	if cookable then
		inst.components.inventoryitem.atlasname = "images/inventoryimages/musha_egg3.xml"
        inst:AddComponent("cookable")
        inst.components.cookable.product = "musha_egg_cooked3"
    end
...
local function crackedfn()
   local inst = defaultfn("idle_happy")
	...
	inst.components.inventoryitem.atlasname = "images/inventoryimages/musha_egg_cracked3.xml"
...
local function cookedfn()
	...
	inst.components.inventoryitem:ChangeImageName("musha_egg_cracked3")
	inst.components.inventoryitem.atlasname = "images/inventoryimages/musha_egg_cracked3.xml"
...
return Prefab( "common/inventory/musha_egg3", normalfn, assets, prefabs),
		Prefab( "common/inventory/musha_egg_cracked3", crackedfn, assets),
		Prefab("musha_egg_cooked3", cookedfn, assets)