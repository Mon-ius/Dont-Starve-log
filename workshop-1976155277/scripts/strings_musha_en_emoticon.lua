...
STRINGS.CHARACTER_DESCRIPTIONS.musha = "[Level up and unlock various Skills]\nStat(L) Skill(K) Visual(P)\nValkyrie(R) Shadow(G) Shield(C) Music(X) Sleep(T) Yamche(Z,V,B)"
...
STRINGS.MUSHA_ASSASIN_WEBBER_WIN4 = "Spider chikin"
...
STRINGS.MUSHA_TALK_SNEAK_NOT_CREATURE = "It is not creature.."
...
STRINGS.MUSHA_ASSASIN_WEBBER_POP13 = "I know you did, You deserve revenge !"
